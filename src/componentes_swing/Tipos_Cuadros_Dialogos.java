	...
	private class Accion_botones implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource()==boton1){
				...
				JOptionPane.showMessageDialog(Lamina_Cuadros_Dialogos.this,"Hola","Alerta",0);
				...
				JOptionPane.showConfirmDialog(Lamina_Cuadros_Dialogos.this, "Hola","Atencion",1);
				...
				JOptionPane.showOptionDialog(Lamina_Cuadros_Dialogos.this, "Elije", "v de opciones", 1, 1, null, null,null);
